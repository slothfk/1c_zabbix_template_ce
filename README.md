...
* ТОП серверных вызовов по суммарному процессорному времени (по-умолчанию деактивирова);
...
* Отсутсвуют процессы ragent. Уровень важности - <b>Высокая</b>;
* Отсутсвуют процессы rmngr. Уровень важности - <b>Высокая</b>;
* Отсутсвуют процессы rphost. Уровень важности - <b>Высокая</b>;
...
* Количество ошибко по процессам ragent, rmngr и rphost;
